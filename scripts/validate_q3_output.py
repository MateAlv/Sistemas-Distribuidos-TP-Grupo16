...
DATASET_DIR = os.environ.get("Q3_DATASET_DIR", "data/datasets/LI-Mini")
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    success = ref.validate_query("q3", DATASET_DIR, DATASET_TRANS)
    print("=" * 60)
    if success:
        print(ref.green("✓✓✓ Q3 TEST PASSED ✓✓✓"))
        sys.exit(0)
    print(ref.red("✗✗✗ Q3 TEST FAILED ✗✗✗"))
    sys.exit(1)
